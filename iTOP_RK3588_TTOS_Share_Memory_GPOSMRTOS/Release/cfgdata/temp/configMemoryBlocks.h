...
#define CONFIG_VM_SPACEBLOCKS_vm1    {\
		{("vm1RamSpace"),(0x100000),(0x50000000ull),(0xc800000),(MM_DEFAULT_USER_ATTR),(MM_PAGE_SIZE_4KB)}\
		,{"null",0,0,0,0,0}		}


/*分区vm2配置*/
#define CONFIG_VM_SPACEBLOCKS_vm2    {\
		{("vm2RamSpace"),(0x100000),(0x5c800000ull),(0xc800000),(MM_DEFAULT_USER_ATTR),(MM_PAGE_SIZE_4KB)}\
		,{"null",0,0,0,0,0}		}
