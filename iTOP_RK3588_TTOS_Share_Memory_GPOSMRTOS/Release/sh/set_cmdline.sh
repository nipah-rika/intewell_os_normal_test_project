#!/bin/bash
sync
cmd_line="stmmacmask=0x0 nohugeiomap pci=assign-busses idle=poll nohalt memmap=4K\\\$0x1000 memmap=4K\\\$0x42000 memmap=256M\\\$0x40000000 memmap=7M\\\$0x4f900000 memmap=400M\\\$0xc0000000  dmamap=400M@0xc0000000 dmamap=32M@0x42de1000"
grub_file="/boot/efi/EFI/BOOT/grub.cfg"
NO_REBOOT="Please reboot"
