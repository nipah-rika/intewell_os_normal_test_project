...
#define CONFIG_RTRE_CPU_MASK ((1<<0)|(1<<1)|(1<<2)|(1<<3))
#define CONFIG_RTRE_START (0x40000000)
#define CONFIG_RE_CFG_SPACE_START (0x4f900000)
#define CONFIG_RE_CFG_SPACE_MEMORY (0x700000)
#define ARRAY_SIZE(a) (sizeof(a) / sizeof((a)[0]))
#define CONFIG_RT_TA_SPACE_START (0x40000000)
