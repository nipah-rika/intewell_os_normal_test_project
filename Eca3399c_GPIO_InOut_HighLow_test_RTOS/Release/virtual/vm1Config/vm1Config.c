...
#define CONFIG_vm1_GOIO_GROUP_NUMBER (1)
/**************************配置数据变量*********************************/
...
struct{
    ...
    .header = {
        ...
        .imageName = "Eca3399c_GPIO_InOut_HighLow_test_App.bin",
        .graphic = TRUE,
        .ps2Keyboard = TRUE,
        .ps2Mouse = TRUE,
        .usb = FALSE,
    ...
    .nicInfo = {
        {
            ...
            .macaddr = {0x52,0x54,0x00,0x07,0xb6,0x68},
            .dns0 = {"192.168.11.1"},
            .dns1 = {"192.168.11.1"},
            .netif_type = NETIF,
        },
        {
            ...
            .mask = ("255.255.255.0"),
            .gateway = ("192.168.115.1"),
            .macaddr = {0x52,0x54,0x00,0x50,0x7f,0x2c},
            .dns0 = {""},
            .dns1 = {""},
