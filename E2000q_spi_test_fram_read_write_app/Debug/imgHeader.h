...
T_TA_ImageInfo g_imageHeader __attribute__((__section__(".image_info"))) = 
{
	...
	{           
		...
		{".ARM_exidx", FALSE,(T_ULONG)load___exidx_start, (T_ULONG)__exidx_start,(T_ULONG)store___exidx_size},
		{".sidata", TRUE,(T_ULONG)load__sidata_start, (T_ULONG)_sidata_start,(T_ULONG)store__sidata_size},
		{".data", FALSE,(T_ULONG)load__data_start, (T_ULONG)_data_start,(T_ULONG)store__sidata_size},
