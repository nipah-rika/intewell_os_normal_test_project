...
#define CONFIG_RTRE_VM_SUM_MEMORY (1024*MB)
#define CONFIG_MEMORY (4*GB)
#define CONFIG_RTRE_VM_MEMORY_START ((UINT64)((CONFIG_MEMORY - CONFIG_RTRE_VM_SUM_MEMORY)/(4*KB)))*(4*KB)
#define CONFIG_CPU_CORE_MASK (B1)
#define CONFIG_RTRE_START_CPU_ID (3)
#define CONFIG_RTRE_CPU_MASK ((1<<3))
#define CONFIG_RTRE_START (0xa0000000)
#define CONFIG_RE_CFG_SPACE_START (0xaf900000)
#define CONFIG_RE_CFG_SPACE_MEMORY (0x700000)
#define ARRAY_SIZE(a) (sizeof(a) / sizeof((a)[0]))
#define CONFIG_RT_TA_SPACE_START (0xa0000000)
