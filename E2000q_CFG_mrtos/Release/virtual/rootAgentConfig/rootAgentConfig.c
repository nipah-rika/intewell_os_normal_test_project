...
#define CONFIG_rootAgent_MEMORY (128*MB)
...
#define CONFIG_rootAgent_GOIO_GROUP_NUMBER (0)
/**************************配置数据变量*********************************/
...
struct{
    ...
    T_VM_GPIO_GROUP_INFO gpioGroupInfo[CONFIG_rootAgent_GOIO_GROUP_NUMBER];
    ...
    .header = {
        ...
        .gpioGroupNumber = CONFIG_rootAgent_GOIO_GROUP_NUMBER,
    },
    .uartInfo = {
    },
    .usbInfo = {
    ...
    .nicInfo = {
        {
            ...
            .mask = ("255.255.255.0"),
            .gateway = (""),
            .macaddr = {0x52,0x54,0x00,0xb6,0x81,0x64},
            .dns0 = {""},
            .dns1 = {""},
