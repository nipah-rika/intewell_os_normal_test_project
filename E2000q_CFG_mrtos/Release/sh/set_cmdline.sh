#!/bin/bash
sync
cmd_line="stmmacmask=0x1 nohugeiomap pci=assign-busses idle=poll nohalt memmap=4K\\\$0x1000 memmap=4K\\\$0x42000 memmap=256M\\\$0xa0000000 memmap=7M\\\$0xaf900000 memmap=1024M\\\$0xc0000000  dmamap=1024M@0xc0000000 dmamap=68M@0xa2de1000"
