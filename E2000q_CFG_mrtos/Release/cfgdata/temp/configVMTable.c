 ...
 */
T_MODULE T_UWORD haclVIntToExIntMaprootAgent[64]=
{
	0x26,/*0*/
	0x27,/*1*/
	0x2,/*2*/
...
{
	{
		...
		(0xfffffff400000000ull),
		(0x8000000ull),
		(VMK_SVM_RESET_VM_MASK
 | VMK_SVM_RESUME_VM_MASK
 | VMK_SVM_SENDSERVICEVINT_MASK
 | VMK_SVM_START_VM_MASK
 | VMK_SVM_STOP_VM_MASK
 | VMK_SVM_SUSPEND_VM_MASK
),
		vmSpacerootAgent,
		0x8,
