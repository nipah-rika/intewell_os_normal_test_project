...
#define CONFIG_vm1_BIND_CPU_ID (2)
#define CONFIG_vm1_MEMORY (100*MB)
...
#define CONFIG_vm1_GPIO_GROUP_NUMBER (0)
#define CONFIG_vm1_SOC_CAN_NUMBER (0)
/**************************配置数据变量*********************************/
...
struct{
    ...
    T_VM_GPIO_GROUP_INFO gpioGroupInfo[CONFIG_vm1_GPIO_GROUP_NUMBER];
    T_VM_SOC_CAN_INFO socCanInfo[CONFIG_vm1_SOC_CAN_NUMBER];
    ...
    .header = {
        ...
        .imageName = "app_semidrive_multicast_test.bin",
        .graphic = TRUE,
        .ps2Keyboard = TRUE,
        .ps2Mouse = TRUE,
        .usb = TRUE,
        ...
        .gpioGroupNumber = CONFIG_vm1_GPIO_GROUP_NUMBER,
        .socCanNumber = CONFIG_vm1_SOC_CAN_NUMBER,
    },
    .uartInfo = {
    },
    .usbInfo = {
    ...
    .nicInfo = {
        {
            ...
            .mask = ("255.255.255.0"),
            .gateway = (""),
            .macaddr = {0x52,0x54,0x00,0xca,0x8f,0x92},
            .dns0 = {""},
            .dns1 = {""},
            .netif_type = NETIF,
        }
