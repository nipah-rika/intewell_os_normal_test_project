; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27049.0 
	...
	TITLE	H:\shmm\intewellrtre_windows-testshmm(1)\intewellrtre_windows-testshmm\gpos\src\exe\testshmm\shm_read.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	ENDS
_DATA	SEGMENT
$SG46443 DB	'shm_w', 00H
	ORG $+2
$SG46444 DB	'shm_r', 00H
	ORG $+2
$SG46447 DB	'shm_w open failed!!!', 0dH, 0aH, 00H
	ORG $+1
$SG46448 DB	'shm_w open success!!!', 0dH, 0aH, 00H
$SG46449 DB	'shm_w_ptr: %p', 0aH, 00H
	ORG $+1
$SG46452 DB	'shm_r open failed!!!', 0dH, 0aH, 00H
	ORG $+1
$SG46453 DB	'shm_r open success!!!', 0dH, 0aH, 00H
$SG46454 DB	'shm_r_ptr: %p', 0aH, 00H
	ORG $+1
$SG46456 DB	'Test Failed!!!', 0dH, 0aH, 00H
_DATA	ENDS
