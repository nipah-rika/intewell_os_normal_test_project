...
#define CONFIG_VMK_SPACEBLOCKS    {\
		...
		,{("virtualDevice"),(0xa7200000ull),(0xa7200000ull),(0x300000ull),(MM_DEFAULT_USER_DATA_ATTR),(MM_PAGE_SIZE_4KB)}\
		,{("shmRamSpace"),(0xa7500000ull),(0xa7500000ull),(0x4000000ull),(MM_DEFAULT_USER_DATA_ATTR),(MM_PAGE_SIZE_4KB)}\
...
#define CONFIG_VM_SPACEBLOCKS_vm1    {\
		{("vm1RamSpace"),(0xfffffff400000000ull),(0xb0000000ull),(0x10000000ull),(MM_DEFAULT_USER_ATTR),(MM_PAGE_SIZE_4KB)}\
		,{"null",0ull,0ull,0ull,0ull,0ull}		}


/*分区vm2配置*/
#define CONFIG_VM_SPACEBLOCKS_vm2    {\
		{("vm2RamSpace"),(0xfffffff400000000ull),(0xc0000000ull),(0x10000000ull),(MM_DEFAULT_USER_ATTR),(MM_PAGE_SIZE_4KB)}\
		,{"null",0ull,0ull,0ull,0ull,0ull}		}
