...
pdata	ENDS
pdata	SEGMENT
$pdata$shm_write DD imagerel $LN14
	DD	imagerel $LN14+272
...
pdata	ENDS
_DATA	SEGMENT
$SG47324 DB	'shm_w', 00H
	ORG $+2
$SG47325 DB	'shm_r', 00H
	ORG $+2
$SG47328 DB	'shm_w open failed!!!', 0dH, 0aH, 00H
	ORG $+1
$SG47329 DB	'shm_w open success!!!', 0dH, 0aH, 00H
$SG47330 DB	'shm_w_ptr: %p', 0aH, 00H
	ORG $+1
$SG47333 DB	'shm_r open failed!!!', 0dH, 0aH, 00H
	ORG $+1
$SG47334 DB	'shm_r open success!!!', 0dH, 0aH, 00H
$SG47335 DB	'shm_r_ptr: %p', 0aH, 00H
	ORG $+1
$SG47337 DB	'Test Failed!!!', 0dH, 0aH, 00H
_DATA	ENDS
xdata	SEGMENT
...
; File d:\tzp\rtre_windows\intewellrtre_windows-testshmm\src\exe\testshmm\shm_read.c
_TEXT	SEGMENT
argc$ = 48
argv$ = 56
main	PROC
...
; 33   : 		printf("shm_w open success!!!\r\n");
	...
	lea	rcx, OFFSET FLAT:$SG47329
	call	printf

; 34   : 		printf("shm_w_ptr: %p\n", shm_w_ptr);

	mov	rdx, QWORD PTR shm_w_ptr$[rsp]
	lea	rcx, OFFSET FLAT:$SG47330
	call	printf
$LN7@shm_write:
...
; 44   : 		printf("shm_r open success!!!\r\n");
	...
	lea	rcx, OFFSET FLAT:$SG47334
	call	printf

; 45   : 		printf("shm_r_ptr: %p\n", shm_r_ptr);

	mov	rdx, QWORD PTR shm_r_ptr$[rsp]
	lea	rcx, OFFSET FLAT:$SG47335
	call	printf
$LN9@shm_write:
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File d:\windows kits\10\include\10.0.17763.0\ucrt\stdio.h
;	COMDAT printf
_TEXT	SEGMENT
_Result$ = 32
_ArgList$ = 40
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File d:\windows kits\10\include\10.0.17763.0\ucrt\corecrt_stdio_config.h
