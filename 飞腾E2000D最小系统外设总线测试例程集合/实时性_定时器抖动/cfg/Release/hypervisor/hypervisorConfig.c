...
#define CONFIG_RTRE_VM_SUM_MEMORY (3838*MB)
#define CONFIG_RTRE_UART_NUMBER (9)
#define CONFIG_RTRE_UART {{("COM1")},{("COM2")},{("COM3")},{("COM4")},{("COM5")},{("COM6")},{("COM11")},{("COM12")},{("COM20")}}
#define CONFIG_RTRE_NIC_NUMBER (3)
#define CONFIG_RTRE_NIC {{("GEM0")},{("GEM1")},{("GEM2")}}

#define CONFIG_RTRE_CPU_MASK ((1<<0)|(1<<1))
//非实时运行环境
