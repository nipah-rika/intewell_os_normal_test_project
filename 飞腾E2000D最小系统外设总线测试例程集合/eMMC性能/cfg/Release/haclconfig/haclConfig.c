...
#define CONFIG_CPU_CORE_MASK (B11)
#define CONFIG_RTRE_START_CPU_ID (0)
#define CONFIG_RTRE_CPU_MASK ((1<<0)|(1<<1))
#define CONFIG_RTRE_START (0x80000000)
#define CONFIG_RE_CFG_SPACE_START (0x8f900000)
#define CONFIG_RE_CFG_SPACE_MEMORY (0x700000)
#define ARRAY_SIZE(a) (sizeof(a) / sizeof((a)[0]))
#define CONFIG_RT_TA_SPACE_START (0x80000000)
